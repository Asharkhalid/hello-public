...
export const agents = pgTable("agents", {
  ...
  // Blueprint snapshot (version isolation) - contains Session[] array
...
export const agentBlueprintsRelations = relations(agentBlueprints, ({ many }) => ({
  agents: many(agents),
}));
...
export const meetings = pgTable("meetings", {
  ...
  progress: jsonb("progress").default('[]'), // NEW: SessionProgress[] tracking
